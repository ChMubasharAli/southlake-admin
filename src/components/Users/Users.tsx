...
const Users: React.FC = () => {
  ...
  const handleExportExcel = () => {
    const dataToExport = filteredData.map((student) => ({
      ...
      "After School Enrolled Students":
        student.AfterSchoolProgramForms?.length || 0,
      "Music Programs Enrolled Students ":
        student.MusciProgramForms?.length || 0,
      "Online Tutoring Enrolled Students":
        student.OnlineTutoringForms?.length || 0,
      "Private & Test Prep Enrolled Students":
        student.PrivateAndTestPrepForms?.length || 0,
      "Enrichment Classes Enrolled Students":
        student.SingleProgramForms?.length || 0,
      "South Camp Programs Enrolled Students": student.CampForms?.length || 0,
    }));
